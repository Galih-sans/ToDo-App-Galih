...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // saat load webpage, todo meng-load array dari localwebstorage
    if (isStorageExist()) {
        loadDataFromStorage();
    }
});
...
document.addEventListener(SAVED_EVENT, function () {
    console.log(localStorage.getItem(STORAGE_KEY)); // TAMBAHAN KEDEPAN BUAT PEMBERITAHUAN SNACKBAR / TOAST
});
